...
<div class='blog-posts hfeed'>
	...
	<div class="date-outer">
        ...
        <br />
                 <input type="password" class="campo_formulario" name="passwor" id="password">

                </p>  
                <p>
                <label for="usuario">Nueva contraseña</label>
        <br />
                 <input type="password" class="campo_formulario" name="nueva_contraseña" id="nueva_contraseña">
